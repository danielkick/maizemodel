...
if use_sklearn_model == 'hps_rf':
    if data_list_index == 0:   # G
        params = {
            'midpoint_max_depth':64,
            'midpoint_min_samples_leaf':171 
        }    
    elif data_list_index == 1: # S
        params = {
            'midpoint_max_depth':10,
            'midpoint_min_samples_leaf':163 
        }          
    elif data_list_index == 3: # W1
        params = {
            'midpoint_max_depth':102,
            'midpoint_min_samples_leaf': 100
        }          
    elif data_list_index == 4: # Cat
        params = {
            'midpoint_max_depth':7,
            'midpoint_min_samples_leaf':149 
        }          
...
for ith_rep in range(10):
    ...
    model_in_out_json_name = model_name+'_rep'+str(ith_rep)+'.json'
